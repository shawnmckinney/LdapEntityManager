...
class ConnectionProvider
{
	...
	/**
	 * Synchronized getter guards access to reference to self which is a
	 * singleton and only be created the first time invoked.
	 *
	...
	/**
	 * Private constructor calls the init method which initializes the
	 * connection pools.
	 *
	 */
	...
	/**
	 * Initialize the three connection pools using settings and coordinates
